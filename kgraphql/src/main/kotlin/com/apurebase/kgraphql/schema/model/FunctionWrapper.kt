...
interface AccessPropertiesRule<T> {
    fun access(context: Context, /*properties: Collection<KProperty<*>>, */item: T): Map<KProperty<*>, GraphQlErrorInfo?>
}
...
interface FunctionWrapper<T> : Publisher {
    ...
    var checkAccess: AccessPropertiesRule<Any?>?
    ...
    abstract class Base<T> : FunctionWrapper<T> {
        ...
        override var checkAccess: AccessPropertiesRule<Any?>? = null
    }
